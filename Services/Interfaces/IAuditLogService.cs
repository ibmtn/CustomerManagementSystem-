...
namespace KcetasWeb.Services.Interfaces
{
    public interface IAuditLogService
    {
        ...
        System.Threading.Tasks.Task<PaginatedResponse<AuditLog>> GetAllAsync(int page = 1, int pageSize = 100, string? q = null, string? kullanici = null, int? kayitId = null, string? islemTipi = null, string? tarih = null);
    }
}

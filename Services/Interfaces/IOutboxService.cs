...
public interface IOutboxService
{
    ...
    Task<PaginatedResponse<EntegrasyonOutbox>> FiltreleAsync(string? durum, string? hedefSistem, DateTime? baslangic, DateTime? bitis, string? faturaNo = null, long? kayitNo = null, DateTime? sonDenemeTarihi = null, int page = 1, int pageSize = 50);
